...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/*
		 * p1.getCategories() = para acessar a coleção de categorias do produto 1
		 * .add(cat2) = Para adicionar o cat2 na coleção do produto 1
		 */
		...
		//Para salvar os produtos mas agora com as associações
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
		...
		/* OrderItem oi1 é um item de pedido, do pedido 1(o1), do produto1 (p1)
		 * quantidade 2, e o preço é o p1.getPrice()
		 */
